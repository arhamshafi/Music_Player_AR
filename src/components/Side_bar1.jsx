...
function Side_bar1() {
    ...
    let {side_bar1} = useContext(App_context)
    ...
    return (
        ...
        <>
            <div className={`w-[200px] lg:w-[15%] min-h-screen text-white transition-all ease-in-out duration-300 bg-black fixed top-0 ${side_bar1 ? "left-0" : "left-[-205px]" } z-10 lg:relative lg:left-0 `}>
