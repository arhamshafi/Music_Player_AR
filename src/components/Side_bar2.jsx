  ...
  return (
    <>
      <div className={`w-[300px] lg:block hidden xl:w-[20%] min-h-screen px-2 py-3 bg-[#1a1a1a]`}  >
        <div className='py-4 relative px-3 rounded-2xl text-sm tw_sh text-white tw_sh mt-2 tracking-[1px]'>Welcome !  <span className='text-orange-400 to_sh text-lg'>{crnt_user.name}</span>  <GiCaptainHatProfile className='text-white absolute top-0 left-1 -rotate-25 text-2xl' /></div>
      </div>
      {/* ////////// */}
